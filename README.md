...
|---|---|---|
| Charter, architecture, ADRs | **Written** — 29 decisions recorded, 8 layers specified | Each layer document carries a status marker; `./scripts/doctor` checks both |
...
| L0 facility model and generators | **Working** — 1 zone, 6 types, 14 assets, 5 stations; every derived artifact generated byte-identically | `./scripts/validate-model`; 183 host tests |
...
| L3 skills | **Partial** — 4 of 6 (`MoveTo`, `Grasp`, `Pick`, `Place`) | `MoveTo` asserted in the bring-up scenario |
