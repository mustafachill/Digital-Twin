...
| The skill server runs on simulation time | Read `_skill_parameters`, `simulation.launch.py:930-965` | `"use_sim_time": True` at `:952`, delivered with every other skill parameter |
