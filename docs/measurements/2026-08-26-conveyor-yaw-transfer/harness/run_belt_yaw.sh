#!/usr/bin/env bash
# One INTERLEAVED belt block: bring the full cell up headless, ride N parts down
# conveyor_1 alternating spawn yaw and belt mode, bring it down.
#
#   run_belt_yaw.sh <label> <trials> [extra args for the harness...]
#
